    ...
    <div className="h-20 flex justify-between items-center px-4 lg:px-6">
      <div className="flex items-center">
        ...
        <div className="hidden lg:inline-block">
          <Link href="/dashboard">
            <a>
              <span className="text-2xl text-primary-500 font-semibold">Muslims App</span>
            </a>
          </Link>
        </div>
      ...
      {router.asPath === '/dashboard' && (
        <div className=" md:w-96">
          <SearchInput defaultValue={''} placeholder={'Поиск суры'} onChange={debouncedChangeHandler} />
        </div>
      )}
      <div className="flex items-center">
        <button
