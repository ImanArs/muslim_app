...
const ReadSection = () => {
  ...
  return (
    <div className="container mt-24">
      <h2 className="font-semibold text-4xl text-center text-gray-800">Читайте Коран каждый день!</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="h-7 w-7 group-hover:text-white flex items-center justify-center bg-primary-50 text-primary-500 text-sm rounded-full">
                    {surah.number}
                  </span>
