        ...
        <main>
            <div className="mt-[60px] md:mt-0">
                ...
                <section className="mt-5">
                    <p className="mt-5">Затем молящийся снова произносит такбир «Аллаху Акбар» и совершает второй суджуд. Он выполняется точно так же, как и первый.</p>
                    ...
                    <p className="mt-5">После второго земного поклона молящийся возвращается в вертикальное положение.</p>
