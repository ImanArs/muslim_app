        ...
        <main>
            <div className="mt-[60px] md:mt-0">
                ...
                <section className="mt-5">
                    <p className="mt-5">После такбира молящийся складывает руки под пупком так, чтобы правая рука обхватывала мизинцем и большим пальцами запястье левой руки. Указательный, средний и безымянный пальцы при этом расположены вдоль внешней стороны кисти и направлены в сторону локтя.</p>
