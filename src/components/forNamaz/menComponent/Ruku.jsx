        ...
        <main>
            <div className="mt-[60px] md:mt-0">
                ...
                <section className="mt-5">
                    ...
                    <p className="mt-5">При совершении поясного поклона желательно, чтобы спина образовала прямой угол с ногами. Шею старайтесь держать прямо, не задирая и не опуская голову.</p>
                    <p className="mt-5">Ладони кладутся на колени и обхватывают их, однако пальцы друг к другу прижимать не нужно. Руки тоже надо стараться выпрямить. Смотреть в положении поясного поклона следует на свои ступни.</p>
                    <div className="mt-5 rounded-3xl">
            ...
            <div className="mt-10 md:flex">
                <Image src="/m-namaz/mruku.png" width={550} height={600} alt="РУКУ"/>
                <div className="mt-10">
                <Box sx={{ width: '100%' }}>
