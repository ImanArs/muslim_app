        ...
        <main>
            <div className="mt-[60px] md:mt-0">
                ...
                <section className="mt-5">
                    <p className="mt-5">После совершения второго саджда, молящийся садится на бедра таким же образом, как в промежутке между двумя земными поклонами и читает ташаххуд. После чтения ташахуда молящийся читает салават. Затем желательно совершить дуа на арабском языке, не поднимая рук.</p>
                    <p>Во время чтения ташахуда на словах: «Ашхаду алля иляха», – молящийся поднимает указательный палец правой руки и направляет его в сторону киблы (но не вверх!), а на словах «илляллах» опускает его. Во время поднятия указательного пальца большой и средний пальцы смыкаются в кольцо, а мизинец и безымянный палец подгибаются. Когда палец опускается, ладонь следует выпрямить и разместить в том же положении (у кромки колена), что и до поднятия пальца. Шевелить указательным пальцем или держать его поднятым на протяжении всего чтения ташаххуда не следует.</p>
                </section>
            </div>
...
Ашхаду алля иляха илляллаху уа ашхаду анна Мухаммадан абдуху уа расулюх</p>
                        ...
                        <p className="mt-5">Аллахумма солли ʼаля Мухаммад, уа ʼаля али Мухаммад
...
Свидетельствую, что нет никого, достойного поклонения, кроме Аллаха, и свидетельствую, что Мухаммад – Его раб и Его Посланник.</p>
                        <p className="mt-5">О Аллах, благослови Мухаммада и семейство Мухаммада,
...
Поистине, Ты – Достойный похвалы, Славный!</p>
<p className="mt-5">О наш Господь! Даруй нам благо в земной жизни и благо в вечной жизни и защити нас от наказания в Аду!</p>
                    </TabPanel>
                </Box>
                </div>
            </div>
