        ...
        <main>
            <div className="mt-[60px] md:mt-0">
                ...
                <section className="mt-5">
                    <p className="mt-5">После чтения салавата и дуа молящийся поворачивает голову направо и произносит салям (или таслим). Затем, поворачивая голову налево, он второй раз произносит салям. При этом молящийся смотрит на край своего плеча.</p>
                    
                </section>
            </div>
            <div className="mt-10 md:flex">
                <div>
                    <Image src="/m-namaz/salam1.png" width={450} height={600} alt="Салям"/>
                    <Image src="/m-namaz/salam2.png" width={450} height={600} alt="Салям"/>
