...
const Tashahud = () => {
 ...
 Второй ракаат на этом завершается.</p>
                </section>
            </div>
            <div className="mt-10 md:flex">
                <div>
                    <Image src="/w-namaz/sitting.png" width={450} height={600} alt="Ташаххуд"/>
                    <Image src="/w-namaz/sitting2.png" width={450} height={600} alt="Ташаххуд"/>
                </div>
                <div className="mt-10">
                <Box sx={{ width: '100%' }}>
