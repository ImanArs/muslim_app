import { FiArrowLeft, FiArrowRight, FiSun, FiSunrise } from "react-icons/fi";
                ...
                <div className="container mt-10">
                    <div className="container mb-5  md:flex justify-between gap-5 items-center bg-white fixed top-[64px] py-5 z-10">
                        <div className="flex gap-5 items-center">
                            <FiSun size={60}/>
                            <div>
                                <h1 className="font-bold text-3xl">ЗУХР</h1>
                                <p className="text-xl">Дневной намаз</p>
                            </div>
                        </div>
                        <div className="my-5">
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                                    <Tab label="4 ракаата сунны" {...a11yProps(0)} />
                                    <Tab label="4 рааката фард" {...a11yProps(1)} />
                                    <Tab label="2 рааката сунны" {...a11yProps(2)} />
                                </Tabs>
                            </Box>
                        </div>
                        <div>
