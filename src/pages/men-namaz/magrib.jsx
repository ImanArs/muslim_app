import { FiArrowLeft, FiArrowRight, FiSunrise, FiSunset } from "react-icons/fi";
        ...
        <div>
            <Header/>
                <div className="container mt-10">
                    <div className="container mb-5 flex justify-between gap-5 items-center bg-white fixed top-[64px] py-5 z-10">
                        <div className="flex gap-5 items-center">
                            <FiSunset size={60}/>
                            <div>
                                <h1 className="font-bold text-3xl">МАГРИБ</h1>
                                <p className="text-xl">Вечерний намаз</p>
                            </div>
                        </div>
                        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                            <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                                <Tab label="3 ракаата фард" {...a11yProps(0)} />
                                <Tab label="2 ракаата сунны" {...a11yProps(1)} />
                            </Tabs>
                        </Box>
                        <div>
